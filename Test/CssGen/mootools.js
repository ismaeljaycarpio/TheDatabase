...
var Sortables = new Class({
    ...
    start: function (C, B) {
        ...
        if (this.options.ghost) {
            ...
            this.ghost = B.clone().inject(this.trash).setStyles({
                position: "absolute",
                left: A.x,
                top: C.page.y - this.offset
            });
...
var Tips = new Class({
    ...
    position: function (A) {
        ...
        this.toolTip.setStyles({
            left: B.x + this.options.offsets.x,
            top: B.y + this.options.offsets.y
        });
    },
    locate: function (B) {
        var D = {
