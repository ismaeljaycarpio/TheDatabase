...
<script runat="server">
    ...
    'Private sBase As String = "../../UserFiles/Editor"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
       ...
       Dim strFilesPhisicalPath as String = CType(Session.Item("FilesPhisicalPath"), String) 
        If (Common.HaveAccess(Session("roletype"), "1,2")) Then
            'let global user pass
        Else
        ...
        sCurrentDirectory = strFilesPhisicalPath & sBase  &    Request.QueryString("path")
    ...
    Protected Sub showFiles()
        ...
        'Dim sResMapPath As String = Server.MapPath(sBase) 
         Dim strFilesPhisicalPath as String = CType(Session.Item("FilesPhisicalPath"), String) 
        Dim sResMapPath As String = strFilesPhisicalPath & sBase
        ...
        With My.Computer.FileSystem
            ...
            Else
                ...
                If (Common.HaveAccess(Session("roletype"), "1")) Then
                    btnDelete.Visible = True
                Else
                    btnDelete.Visible = False
                End If
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        With FileUpload1.PostedFile
            ...
            If Not (.ContentType.ToString = "application/octet-stream" Or .ContentType.ToString = "application/xml" _
                ...
                Dim strFileName As String = Guid.NewGuid().ToString() + "_" + FileUpload1.FileName
                FileUpload1.SaveAs(sCurrentDirectory & "\" & strFileName)
                lblUploadStatus.Text = ""
                'Dim sResMapPath As String = Server.MapPath(sBase)

                txtURL.Value = hfRootURL.Value & "/" & strFileName
                
                'ScriptManager.RegisterStartupScript(Page, GetType(Page), "closew", "doOK();", True)
    ...
    Function GetFileUrl(ByVal s As String) As String
        If bUseAbsoluteUrl Then
            'Return AppSrvPath() & s
            Return AppSrvPath() & s.Replace("..", "/Editor")
        Else
            Return s
        End If
    End Function
...
<head id="Head1" runat="server">
    ...
    function showhideManager()
        ...
        if(document.getElementById("divManagerContent").style.display=="none")
            ...
            document.getElementById("divScroll").style.height="0px";
...
<asp:Label ID="lblFolder" meta:resourcekey="lblFolder" runat="server" Text="Folder: " style="display:none;"></asp:Label>
<asp:Label ID="lblPath" runat="server" Text=""  style="display:none;"></asp:Label>

 <asp:HiddenField  runat="server" ID="hfRootURL" Value=""/>
...
<asp:Panel ID="panelManager" runat="server">
 ...
 <table style="margin-left:5px;margin-top:12px;margin-bottom:7px">
     <tr>
         ...
         <td>
             <input id="txtURL" type="text" style="width: 400px" runat="server" clientidmode="Static" />
         </td>
         <td>
             <asp:Label ID="lblSource" meta:resourcekey="lblSource" runat="server" Text="Source"
    ...
    <asp:Panel ID="panelSpecial" runat="server">
        <div id="divManager" onclick="showhideManager()" style=" display:none; text-decoration:underline;cursor:pointer;text-align:left;background:#d6d7d8;padding:5px;">Show Manager</div>
        <div id="divManagerContent" style="background:#f6f7f8;padding:10px;height:70px;border:#d6d7d8 1px solid;border-top:none;">
...
<div runat="server" id="divScroll" style=" display:none; height:0px;overflow:auto;background:white;padding:0px;border-bottom:#cccccc 1px solid;">    
