        ...
        { 
            ...
            if(evt.shiftKey) {
              ...
              if(obj.returnKeyMode==1) {
                  ...
                  //if returnKeyMode = 2 or others, insert br
                  //default behavior;
              }
            }
        }   
...
function $applyReturnEvent(evt, obj, tag) {
    ...
    if(el) { 
      ...
      //if the fragment is empty, create new one). This happen if the cursor is located at the end of line.
...
function ddAction(tb, id, edt, sfx) {
  ...
  switch(btn) {
    ...
    case "btnPreview3": 
      ...
      break;
    case "btnTextFormatting": if(!e.customDialogShow("TextFormatting")) modelessDialogShow(e.scriptPath+"text1.htm",511,480); break;
    ...
    case "btnListFormatting": if(!e.customDialogShow("ListFormatting")) modelessDialogShow(e.scriptPath+"list.htm",303,335); break;
    case "btnBoxFormatting": if(!e.customDialogShow("BoxFormatting")) modelessDialogShow(e.scriptPath+"box.htm",498,395); break;
    case "btnCssText": if(!e.customDialogShow("CssText")) modelessDialogShow(e.scriptPath+"styles_cssText.htm",360,352); break;
