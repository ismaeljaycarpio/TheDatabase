<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thanks.aspx.cs" MasterPageFile="~/Home/Marketing2.master"
    Inherits="paypal_thanks" %>
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <%--<DBGurus:DBGContent ID="dbgContentCommon" runat="server" ConnectionName="CnString"
                                        ContentKey="Payment_thanks" TableName="Content" ExtenderPath="Extender/" ShowInlineContentEditor="false"
