<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true"
    CodeFile="Terminology.aspx.cs" Inherits="Pages_Security_Terminology" EnableEventValidation="false" %>
   ...
   <script type="text/javascript">
       ...
       function SelectAllCheckboxes(spanChk) {
           ...
           for (i = 0; i < elm.length; i++)
               ...
               if (elm[i].type == "checkbox" && elm[i].id != theBox.id && elm[i].id != 'ctl00_HomeContentPlaceHolder_chkIsActive' && elm[i].id != 'ctl00_HomeContentPlaceHolder_rlOne_chkShowOnlyWarning' && elm[i].id != 'ctl00_HomeContentPlaceHolder_rlOne_chkShowAdvancedOptions') {
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" style="width: 50%;">
                                    <span class="TopTitle">Terminology</span>
                                </td>
                                <td align="left">
                ...
                <tr>
                    ...
                    <td valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ddlPageName" CssClass="NormalTextBox" DataTextField="PageName"
                                                ...
                                                onselectedindexchanged="ddlPageName_SelectedIndexChanged"  Width="250px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                        </td>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtInpuText" CssClass="NormalTextBox" Width="250px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtOutputText" CssClass="NormalTextBox"  Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            AllowSorting="True" DataKeyNames="TerminologyID" HeaderStyle-ForeColor="Black"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="LblID" runat="server" Text='<%# Eval("TerminologyID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="EditHyperLink" runat="server" ToolTip="Edit" NavigateUrl='<%# GetEditURL() + Cryptography.Encrypt(Eval("TerminologyID").ToString()) %>'
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hlview" runat="server" ToolTip="View" NavigateUrl='<%# GetViewURL() + Cryptography.Encrypt(Eval("TerminologyID").ToString()) %>'
                                            ImageUrl="~/App_Themes/Default/Images/iconShow.png" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="PageName" HeaderText="Page Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPageName" runat="server" Text='<%# Eval("PageName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="InputText" HeaderText="Input Text">
                                    <ItemTemplate>
                                        <asp:Label ID="lblInputText" runat="server" Text='<%# Eval("InputText") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Output Text" SortExpression="OutputText">
                                    <ItemTemplate>
                                        <asp:Label ID="lblOutputText" runat="server" Text='<%# Eval("OutputText") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
