<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true"
    CodeFile="Usage.aspx.cs" Inherits="Pages_Security_Usage" EnableEventValidation="false" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" style="width: 50%;">
                                    <span class="TopTitle">Usage</span>
                                </td>
                                <td align="left">
                ...
                <tr>
                    ...
                    <td valign="top">
                            ...
                            <div id="search" style="padding-bottom: 10px" onkeypress="abc();">
                                ...
                                <table style="border-collapse: collapse" cellpadding="4">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ddlAccount" DataValueField="AccountID" DataTextField="AccountName"
                                                CssClass="NormalTextBox" AutoPostBack="true" OnSelectedIndexChanged="ddlAccount_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="right">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlCountBy" runat="server" CssClass="NormalTextBox" AutoPostBack="true"
                                                OnSelectedIndexChanged="ddlCountBy_SelectedIndexChanged">
                                                <asp:ListItem Text="Signed In" Value="S"></asp:ListItem>
                                                <asp:ListItem Text="Uploaded" Value="U"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td colspan="3">
                                        </td>
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            AllowPaging="True" AllowSorting="True" DataKeyNames="UsageID" HeaderStyle-ForeColor="Black"
                            ...
                            <Columns>
                                  <asp:TemplateField Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LblID" runat="server" Text='<%# Eval("UsageID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="Date" SortExpression="Date" HeaderText="Date"
                                 ...
                                 <asp:TemplateField HeaderText="Count" SortExpression ="SignedInCount">
                                        <ItemStyle  HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblSignedInCount" runat="server" Text='<%# Eval("SignedInCount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                     <asp:TemplateField HeaderText="Count" SortExpression ="UploadedCount">
                                        <ItemStyle  HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblUploadedCount" runat="server" Text='<%# Eval("UploadedCount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <PagerTemplate>
                                <asp:GridViewPager runat="server" ID="Pager" IsInLine="true" HideAdd="true" HideDelete="true"  OnExportForCSV="Pager_OnExportForCSV"
