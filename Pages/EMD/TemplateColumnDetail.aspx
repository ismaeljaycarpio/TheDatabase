<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Popup.master"
 AutoEventWireup="true" CodeFile="TemplateColumnDetail.aspx.cs" Inherits="Pages_EMD_TemplateColumnDetail" %>
    ...
    <div style="width:100%;">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Label runat="server" ID="lblDetailTitle" Font-Size="16px"
                                 Font-Bold="true" Text="Analytes"> </asp:Label>
                                <br />
                                <br />
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top">
                                ...
                                <asp:ListBox runat="server" ID="lstNotUsed" style="min-width:400px;" Height="350px" 
                            ...
                            <td align="left" valign="top">
                                ...
                                <asp:ListBox runat="server" ID="lstUsed"  style="min-width:400px;"  Height="350px" 
                                SelectionMode="Multiple"></asp:ListBox>
      ...
      <script type="text/javascript">
          ...
          function CloseAndRefresh() {
              window.parent.document.getElementById('btnRefreshColumns').click();
