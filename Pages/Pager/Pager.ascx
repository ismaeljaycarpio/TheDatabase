    ...
    <ContentTemplate>
        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkGo">
            <div class="pagercorner">
                <div runat="server" id="divPagerGradient" class="pagergradient">
                    <%-- onkeypress="pagerabc();"--%>
                            ...
                            <td>
                                <div style="max-width:1200px;">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr style="height: 36px;">
                                            ...
                                            <td style="width: 35%;" runat="server" id="tdAddPart">
                                                <asp:HyperLink ID="HyperAdd" runat="server" ImageUrl="Images/add.png" ToolTip="Add" Visible="true">                                   
                                                </asp:HyperLink>
                                    ...
                                    CausesValidation="False" ToolTip="Add" />--%>
                                                ...
                                                <%--<asp:HyperLink ID="hlDeleteURL" runat="server"                         
                                    ToolTip="Delete" Visible="false">                                
                                    <img alt="" id="Img2" runat="server" src="Images/delete.png" style="border-width: 0" />
                                </asp:HyperLink>--%>
                                                ...
                                                <asp:LinkButton ID="lnkUnDelete" runat="server" CausesValidation="false" Visible="false"
                                                    ToolTip="Restore" OnClick="lnkUnDelete_Click">
                                                    <img alt="" id="Img3" runat="server" src="Images/restore.png" style="border-width: 0" />
                                                </asp:LinkButton>
                                                <asp:LinkButton ID="lnkParmanentDelete" runat="server" CausesValidation="false" Visible="false"
                                                ...
                                                <asp:LinkButton ID="lnkAllExport" runat="server" OnClick="cmdAllExport_Click"
                                                    CausesValidation="False" ToolTip="Export" Visible="false">
                                                    <img alt="" id="Img2" runat="server" src="Images/excel.png" style="border-width: 0" />
                                                </asp:LinkButton>
                                                ...
                                                <asp:LinkButton ID="lnkEditMany" runat="server" CausesValidation="false" Visible="false"
                                            ...
                                            <td style="padding-left: 5px">
                                                <table border="0" width="100%" id="tblNavigation"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td rowspan="2" width="28" runat="server" id="trPageCount">of
                                            ...
                                            <td width="10" id="tdPageSizeRow3" runat="server"></td>
                                            <td width="20">
                                                <asp:ImageButton ID="imgcach4" runat="server" ImageUrl="Images/cach.png" />
                                            </td>
                                            <td>
                                                <div runat="server" id="divGo" visible="true">
