...
public partial class Pages_Document_DocumentType : SecurePage
{
    ...
    int _iStartIndex = 0;
    int _iMaxRows = 10;
    string _strGridViewSortColumn = "DocumentTypeName";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    gvTheGrid.GridViewSortColumn = "DocumentTypeName";
                    gvTheGrid.GridViewSortDirection = SortDirection.Ascending;
        ...
        {
            ErrorLog theErrorLog = new ErrorLog(null, "Document Type", ex.Message, ex.StackTrace, DateTime.Now, Request.Path);
    ...
    protected void PopulateSearchCriteria(int iSearchCriteriaID)
    {
        try
        {
            ...
            if (theSearchCriteria != null)
            {
                ...
                txtDocumentType.Text = xmlDoc.FirstChild[txtDocumentType.ID].InnerText;
    ...
    protected void BindTheGrid(int iStartIndex, int iMaxRows)
    {
        ...
        try
        {
            string xml = null;
            xml = @"<root>" +
                   " <" + txtDocumentType.ID + ">" + HttpUtility.HtmlEncode(txtDocumentType.Text) + "</" + txtDocumentType.ID + ">" +
        ...
        try
        {
            ...
            gvTheGrid.DataSource = DocumentManager.ets_DocumentType_Select(null,
                txtDocumentType.Text.Trim().Replace("'", "''"), 
                int.Parse(Session["AccountID"].ToString()),null, null,
    ...
    {
        _gvPager.ExportFileName = "Document Type";
            ...
            if (!string.IsNullOrEmpty(keys))
            {
                ...
                foreach (string sTemp in keys.Split(','))
                {
                    if (!string.IsNullOrEmpty(sTemp))
                    {
                        ...
                        DocumentManager.ets_DocumentType_Delete(int.Parse(sTemp));
    ...
    protected void Pager_OnExportForCSV(object sender, EventArgs e)
    {
        ...
        "attachment;filename=DocumentType.csv");
        Response.Charset = "";
