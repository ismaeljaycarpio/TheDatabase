    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["SearchCriteria"] != null)
            {
                ...
                hlBack.NavigateUrl = Request.Url.Scheme +"://" + Request.Url.Authority + Request.ApplicationPath + "/Pages/Schedule/ScheduleReport.aspx?SearchCriteria=" + Request.QueryString["SearchCriteria"].ToString();
            }
            else
            {

                Response.Redirect(Request.Url.Scheme +"://" + Request.Url.Authority + Request.ApplicationPath + "/Pages/Schedule/ScheduleReport.aspx", false);//i think no need
            }
    ...
    protected void PopulateTheRecord()
    {
        try
        {
            ...
            else if (_strActionMode == "view")
            {
                ...
                hlEditLink.NavigateUrl = Request.Url.Scheme +"://" + Request.Url.Authority + Request.ApplicationPath + "/Pages/Schedule/ScheduleReportDetail.aspx?mode=" + Cryptography.Encrypt("edit") + "&SearchCriteria=" + Request.QueryString["SearchCriteria"].ToString() + "&ScheduleReportID=" + Cryptography.Encrypt(theScheduleReport.ScheduleReportID.ToString());
            }
        }
        catch (Exception ex)
        {
