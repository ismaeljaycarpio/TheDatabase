...
public partial class Pages_Record_FormSetFormDetail : SecurePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //    hlBack.NavigateUrl = "http://" + Request.Url.Authority + Request.ApplicationPath + "/Pages/SystemData/FormSetForm.aspx?SearchCriteria=" + Request.QueryString["SearchCriteria"].ToString();
            //}
            //else
            //{

            //    Response.Redirect("http://" + Request.Url.Authority + Request.ApplicationPath + "/Pages/SystemData/FormSetForm.aspx", false);//i think no need
            //}
    ...
    protected void PopulateTheRecord()
    {
        try
        {
            ...
            //    hlEditLink.NavigateUrl = "http://" + Request.Url.Authority + Request.ApplicationPath + "/Pages/SystemData/FormSetFormDetail.aspx?mode=" + Cryptography.Encrypt("edit") + "&SearchCriteria=" + Request.QueryString["SearchCriteria"].ToString() + "&FormSetFormID=" + Cryptography.Encrypt(theFormSetForm.FormSetFormID.ToString());
            //}
        }
        catch (Exception ex)
        {
