...
<asp:Content ID="Content1" ContentPlaceHolderID="HomeContentPlaceHolder" runat="Server">
    ...
    <%-- Ticket 846 TBD on Mobile Responsive: Ismael --%>

    <%-- Page Title: Back/Save/Delete buttons --%>
    <br />
    <div class="row">
            ...
            <div runat="server" id="divDetail">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-inline">
                            <div class="form-group">
                                <label for="txtTable" runat="server" id="stgTableNameCaption">Table</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-inline">
                            <div class="form-group">
                                <label for="chkSummarySearch">Search Field</label>
                                <asp:CheckBox runat="server" ID="chkSummarySearch" Font-Bold="true"
                                    TextAlign="Right" />
                ...
                <%-- Field Name/ Visible To / System Name--%>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-inline">
                            <div class="form-group">
                                <label runat="server" id="stgFieldNameCap" for="txtColumnName">Field Name*</label>
