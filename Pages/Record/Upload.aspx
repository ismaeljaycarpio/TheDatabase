<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true"
    CodeFile="Upload.aspx.cs" Inherits="Pages_Record_Upload" EnableEventValidation="false" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" style="width: 50%;">
                                    <span class="TopTitle">Auto Uploads</span>
                                </td>
                                <td align="left">
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            AllowPaging="True" AllowSorting="True" DataKeyNames="UploadID" HeaderStyle-ForeColor="Black"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="LblID" runat="server" Text='<%# Eval("UploadID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="EditHyperLink" runat="server" ToolTip="Edit" NavigateUrl='<%# GetEditURL() + Cryptography.Encrypt(Eval("UploadID").ToString()) %>'
                                 ...
                                 <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hlview" runat="server" ToolTip="View" NavigateUrl='<%# GetViewURL() + Cryptography.Encrypt(Eval("UploadID").ToString()) %>'
                                            ImageUrl="~/App_Themes/Default/Images/iconShow.png" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="UploadName" HeaderText="Upload Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUploadName" runat="server" Text='<%# Eval("UploadName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Email From" SortExpression="EmailFrom">
                                    <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Use Mapping" SortExpression="UseMapping">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="cbUseMapping" Enabled="false" runat="server" Checked='<%# Eval("UseMapping") %>'></asp:CheckBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
