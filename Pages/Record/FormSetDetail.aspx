<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Popup.master" AutoEventWireup="true"
    CodeFile="FormSetDetail.aspx.cs" Inherits="Pages_Record_FormSetDetail" %>
                            ...
                            <div runat="server" id="divDetail" >
                                <table cellpadding="3">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtFormSetName" runat="server" Width="400px" CssClass="NormalTextBox"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvFormSetName" runat="server" ControlToValidate="txtFormSetName"
                                                ErrorMessage="Form Name - Required"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr runat="server" id="trFormSetForm">
                                        <td>
                                        </td>
                                        <td>
                                                 <div style="padding-left: 20px; padding-top: 10px;">
                                        <asp:GridView ID="grdFormSetForm" runat="server" AutoGenerateColumns="False" DataKeyNames="FormSetFormID"
                                            HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center" CssClass="gridview"
                                            OnRowCommand="grdFormSetFormt_RowCommand" OnRowDataBound="grdFormSetForm_RowDataBound" 
                                            ...
                                            <Columns>
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="LblID" runat="server" Text='<%# Eval("FormSetFormID") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgbtnDelete" runat="server" ImageUrl="~/App_Themes/Default/Images/icon_delete.gif"
                                                            CommandName="deletetype" CommandArgument='<%# Eval("FormSetFormID") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="">
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" CssClass="popuplink" NavigateUrl="~/Pages/Record/FormSetFormDetail.aspx"
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass="sortHandle">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <input type="hidden" id='hfFormSetFormID' value='<%# Eval("FormSetFormID") %>' class='FormSetFormID' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                              
                                                <asp:TemplateField HeaderText="Page Table">
                                                    <ItemTemplate>
                                    ...
                                    <br />
                                    <div runat="server" id="divFormSetForm" visible="false" style="padding-left: 20px;">
                                        <asp:HyperLink runat="server" ID="hlAddFormSetForm" Style="text-decoration: none;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <asp:HiddenField runat="server" ID="hfFormSetGroupID" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
