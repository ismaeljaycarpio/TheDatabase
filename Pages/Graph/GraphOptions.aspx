<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true"
    CodeFile="GraphOptions.aspx.cs" Inherits="Pages_Graph_GraphOption" EnableEventValidation="false" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" style="width: 50%;">
                                    <span class="TopTitle">Saved Graphs</span>
                                </td>
                                <td align="left">
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            <PagerTemplate>
                                <asp:GridViewPager runat="server" ID="Pager" HideDelete="false" HideAdd="true"
                                HideExport="true" OnExportForCSV="Pager_OnExportForCSV" OnDeleteAction="Pager_DeleteAction"
