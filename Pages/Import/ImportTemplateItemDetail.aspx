<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Popup.master"
 AutoEventWireup="true" CodeFile="ImportTemplateItemDetail.aspx.cs" Inherits="Pages_Import_ImportTemplateItemDetail" %>
    ...
    <div style="width:100%;">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Label runat="server" ID="lblDetailTitle" Font-Size="16px"
                                 Font-Bold="true" Text="Import Columns"> </asp:Label>
                                <br />
                                <br />
                            </td>
                        </tr>
      ...
      <script type="text/javascript">
          ...
          function CloseAndRefresh() {
              window.parent.document.getElementById('btnRefreshImportTemplateItem').click();
