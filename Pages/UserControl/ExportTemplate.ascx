<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ExportTemplate.ascx.cs"
     Inherits="Pages_UserControl_ExportTemplate" %>
                    ...
                    <td valign="top">
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="ExportTemplateName" HeaderText="Template">
                                    <ItemTemplate>
