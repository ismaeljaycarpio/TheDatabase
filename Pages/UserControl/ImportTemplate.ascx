<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ImportTemplate.ascx.cs"
     Inherits="Pages_UserControl_ImportTemplate" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr runat="server" visible="false">
                                <td align="left" style="width: 50%;">
                                    <span class="TopTitle">Import Template</span>
                                </td>
                                <td align="left">
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            AllowPaging="True" AllowSorting="True" DataKeyNames="ImportTemplateID" HeaderStyle-ForeColor="Black"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="LblID" runat="server" Text='<%# Eval("ImportTemplateID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="EditHyperLink" runat="server" ToolTip="Edit" NavigateUrl='<%# GetEditURL() + Cryptography.Encrypt(Eval("ImportTemplateID").ToString()) %>'
                                 ...
                                 <%--<asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hlview" runat="server" ToolTip="View" NavigateUrl='<%# GetViewURL() + Cryptography.Encrypt(Eval("ImportTemplateID").ToString()) %>'
                                ...
                                <asp:TemplateField SortExpression="ImportTemplateName" HeaderText="Template">
                                    <ItemTemplate>
                                        <asp:Label ID="lblImportTemplateName" runat="server" Text='<%# Eval("ImportTemplateName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="FileFormat" HeaderText="Format">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFileFormat" runat="server" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="Notes" HeaderText="Notes">
                                    <ItemTemplate>
                                        <asp:Label ID="lblNotes" runat="server" Text='<%# Eval("Notes")==DBNull.Value?"":Eval("Notes") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
