<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true"
    CodeFile="PageCount.aspx.cs" Inherits="Pages_SystemData_PageCount" EnableEventValidation="false" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" style="width: 50%;">
                                    <span class="TopTitle">Visitors</span>
                                </td>
                                <td align="left">
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <dbg:dbgGridView ID="gvTheGrid" runat="server" GridLines="Both" CssClass="gridview"
                            ...
                            AllowPaging="True" AllowSorting="True" HeaderStyle-ForeColor="Black" AutoGenerateColumns="false"
                            PageSize="15" OnSorting="gvTheGrid_Sorting">
                            <PagerSettings Position="Top" />
                            <Columns>
                                <asp:TemplateField>
                                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="viewHyperLink" runat="server" ToolTip="View" NavigateUrl='<%# GetViewURL(Eval("visiteddate").ToString(),Eval("PageURL").ToString())  %>'
                                            ImageUrl="~/App_Themes/Default/Images/iconShow.png" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="visiteddate" SortExpression="visiteddate" HeaderText="Date"
                                    HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center"
                                    ReadOnly="true" />
                                <asp:TemplateField SortExpression="PageURL" HeaderText="Page URL">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPageURL" runat="server" Text='<%# Eval("PageURL") %>' Width="400px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="TotalCount" SortExpression="TotalCount" HeaderText="Count"
                                    ReadOnly="true" />
                            </Columns>
